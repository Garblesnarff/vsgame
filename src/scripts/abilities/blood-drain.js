...
export class BloodDrain extends Ability {
     ...
     * @returns {boolean} - Whether the ability state was changed
     */
    use() {
    ...
    activate() {
        ...
        this.visualEffect.style.left = (this.player.x + this.player.width / 2 - range) + 'px';
        this.visualEffect.style.top = (this.player.y + this.player.height / 2 - range) + 'px';
