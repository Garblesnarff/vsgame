...
export class BatSwarm extends Ability {
                ...
                for (let j = enemies.length - 1; j >= 0; j--) {
                    ...
                    if (this.batCollidesWithEnemy(bat, enemy)) {
                        ...
                        if (this.player.game && this.player.game.particleSystem) {
                            this.player.game.particleSystem.createBloodParticles(bat.x, bat.y, 3);
                        }
     ...
     * @param {Object} bat - Bat object
     * @returns {boolean} - Whether the bat is out of bounds
     */
    isBatOutOfBounds(bat) {
     ...
     */
    batCollidesWithEnemy(bat, enemy) {
        return (
            bat.x > enemy.x &&
     ...
     * @param {number} index - Index of the bat to remove
     */
    removeBat(index) {
