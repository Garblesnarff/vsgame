 ...
 */
export function pointInRectangle(pointX: number, pointY: number, rect: Rectangle): boolean {
    return (
        pointX >= rect.x &&
 ...
 */
export function pointInCircle(pointX: number, pointY: number, circleX: number, circleY: number, radius: number): boolean {
