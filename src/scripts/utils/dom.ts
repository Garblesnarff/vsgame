 ...
 */
export function createProgressBar(value: number = 100, options: ProgressBarOptions = {}): ProgressBar {
 ...
 */
export function positionElement(element: HTMLElement, x: number, y: number, options: PositionOptions = {}): void {
