...
export class Game {
    ...
    upgradeSkill(skillId: string): void {
        ...
        if (skillId === 'autoAttack') {
            ...
            if (bloodLance && !bloodLance.unlocked && this.player.level >= CONFIG.ABILITIES.BLOOD_LANCE.UNLOCK_LEVEL) {
                // Unlock ability
            ...
            if (nightShield && !nightShield.unlocked && this.player.level >= CONFIG.ABILITIES.NIGHT_SHIELD.UNLOCK_LEVEL) {
                // Unlock ability
