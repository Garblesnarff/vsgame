...
import { GameStateManager, defaultStateHandlers } from "./state-manager.js";
...
export class Game {
    ...
    updateAutoAttack() {
        ...
        const now = Date.now();
        if (now - this.player.autoAttack.lastFired <
        ...
        for (const enemy of this.enemies) {
            ...
            if (distance < this.player.autoAttack.range &&
        ...
        for (let i = this.enemies.length - 1; i >= 0; i--) {
            ...
            if (this.player.isAlive &&
                ...
                if (this.player.takeDamage(damageAmount)) {
                    ...
                    this.particleSystem.createBloodParticles(this.player.x + this.player.width / 2, this.player.y + this.player.height / 2, 10);
