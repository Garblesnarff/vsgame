...
export class ShadowDash extends Ability {
    ...
    use() {
        ...
        if (this.player.game && this.player.game.enemies) {
            this.damageEnemiesInPath(dirX, dirY, dashDistance, this.player.game.enemies);
        }
     ...
     */
    damageEnemiesInPath(dirX, dirY, dashDistance, enemies) {
        ...
        for (let i = enemies.length - 1; i >= 0; i--) {
            ...
            if (this.isEnemyInDashPath(enemy, dirX, dirY, dashDistance)) {
                // Apply damage
                if (enemy.takeDamage(damage, (x, y, count) => {
                    if (this.player.game && this.player.game.particleSystem) {
     ...
     */
    isEnemyInDashPath(enemy, dirX, dirY, dashDistance) {
        ...
        const t = Math.max(0, Math.min(1, ((enemyX - startX) * (endX - startX) +
...
//# sourceMappingURL=shadow-dash.js.map