...
export class NightShield extends Ability {
    ...
    createShieldAbsorptionEffect() {
        ...
        if (this.player.game && this.player.game.particleSystem) {
            this.player.game.particleSystem.createShieldParticles(this.player.x + this.player.width / 2, this.player.y + this.player.height / 2, 5);
        }
    }
    /**
        ...
        for (let i = enemies.length - 1; i >= 0; i--) {
            ...
            if (distance <= range) {
                ...
                if (this.player.game.particleSystem) {
                    this.player.game.particleSystem.createBloodParticles(enemy.x + enemy.width / 2, enemy.y + enemy.height / 2, 10);
                }
                // Damage enemy
    ...
    createExplosionEffect() {
        ...
        if (this.player.game && this.player.game.uiManager) {
            this.player.game.uiManager.createShieldExplosion(this.player.x + this.player.width / 2, this.player.y + this.player.height / 2, this.explosionRange);
        }
        else {
...
//# sourceMappingURL=night-shield.js.map