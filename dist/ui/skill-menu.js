...
export class SkillMenu {
    ...
    initializeUpgradeButtons() {
        // Auto Attack upgrade
        const autoAttackButton = document.getElementById("auto-attack-upgrade");
        if (autoAttackButton) {
        ...
        // Blood Drain upgrade
        const bloodDrainButton = document.getElementById("blood-drain-upgrade");
        if (bloodDrainButton) {
        ...
        // Bat Swarm upgrade
        const batSwarmButton = document.getElementById("bat-swarm-upgrade");
        if (batSwarmButton) {
        ...
        // Shadow Dash upgrade
        const shadowDashButton = document.getElementById("shadow-dash-upgrade");
        if (shadowDashButton) {
        ...
        const bloodLanceButton = document.getElementById("blood-lance-upgrade");
        if (bloodLanceButton) {
        ...
        const nightShieldButton = document.getElementById("night-shield-upgrade");
...
//# sourceMappingURL=skill-menu.js.map